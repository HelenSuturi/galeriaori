...
public class galerry extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_galerry);
    ...
    private void cargarImagen() {
        ...
        final AlertDialog.Builder alertOpciones = new AlertDialog.Builder(galerry.this);
        ...
        if (resultCode == RESULT_OK) {
            ...
            switch (requestCode) {
                case COD_SELECCIONA:
                    ...
                    client2.post("http://192.168.43.100:3000/sendimage", params2, new AsyncHttpResponseHandler() {
                        @Override
